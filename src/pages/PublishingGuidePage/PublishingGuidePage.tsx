...
import FontScale from "../../components/FontScale/FontScale";
...
const WeatherPreview = () => {
   ...
   */
  const hasApiKey = !!import.meta.env.VITE_WEATHER_API_KEY;
...
const imageUrls = [
  "https://img-s-msn-com.akamaized.net/tenant/amp/entityid/AA1TGqXc.img?w=700&h=466&m=6&x=224&y=80&s=155&d=155",
